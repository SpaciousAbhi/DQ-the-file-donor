...
VERIFY2_URL = environ.get('VERIFY2_URL', "adrinolinks.in")
VERIFY2_API = environ.get('VERIFY2_API', "780c1aebebabef5f79df4e87122ac4286721ebab")
...
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'Flase')), False)
